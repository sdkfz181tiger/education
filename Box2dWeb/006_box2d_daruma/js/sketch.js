...
window.onload = function(){
	...
	createDoll(C_WIDTH * 0.25, C_HEIGHT / 2);
	createDoll(C_WIDTH * 0.75, C_HEIGHT / 2);
	createDaruma(C_WIDTH * 0.50, C_HEIGHT - 20);

	function createDoll(cX, cY){

		let type = b2Body.b2_dynamicBody;

		let bHead = b2dManager.createBody(type, cX,    cY-20, 32, 32);
