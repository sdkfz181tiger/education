...
/*
	...
	obj2.position.set(-10, 0, -30);// 座標をセット
	group.add(obj2);// 背景に追加

	let tl2 = createTimeline(-1, false, null);//第一引数：ループの回数　-1でループ
	tl2.to(obj2.rotation, 1.0, {delay: 0.0, x: "+=0", y: "+=3.14", z: "+=0"});// 相対位置
	...
	// 第三引数: アニメーション終了時関数
	let tl1 = createTimeline(-1, false, null);//第一引数：ループの回数　-1でループ
