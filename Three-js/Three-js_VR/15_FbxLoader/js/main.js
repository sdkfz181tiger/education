...
const models = {data:[
	...
	{dir:"./models/", mtl:"rpi_L.mtl",  obj:"rpi_L.obj"}
]};
...
window.onload = function(){
	...
	function onReadyModels(){
		...
		*/
		...
		// clone.scale.set(3.3, 3.3, 3.3);
		// clone.position.set(x, y, z);
		// clone.rotation.set(0, 0, 0);
		// tm.addScene(clone);// Add to group!!

		
		// FBXLoader(Test)
		// TODO: FBX たまね HSP
		let loader = new THREE.FBXLoader();
		loader.load("./models/tokyo/source/Export.fbx", (obj)=>{
			...
			obj.position.set(0, 8, 5);
			obj.rotation.set(0, Math.PI*0.2, 0);
			tm.addGroup(obj);
		}, (progress)=>{
			// Do nothing
		}, (error)=>{
