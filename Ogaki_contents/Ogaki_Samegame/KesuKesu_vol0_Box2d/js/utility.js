...
const FIX_DENCITY     = 1.0;
const FIX_FRICTION    = 0.5;
const FIX_RESTITUTION = 0.3;
...
class b2Manager{
	...
	constructor(world){
		...
		this._fixDef.density     = FIX_DENCITY;
		this._fixDef.friction    = FIX_FRICTION;
		this._fixDef.restitution = FIX_RESTITUTION;
