...
(function() {
    ...
    let PATH_9LEAP_START_PNG = "./plugins/start.png";
    let PATH_9LEAP_END_PNG   = "./plugins/end.png";

    /**
     * @type {Object}
     */
    enchant.nineleap = { assets: [PATH_9LEAP_START_PNG, PATH_9LEAP_END_PNG] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets[PATH_9LEAP_START_PNG];
                ...
                this.endScene.image = this.assets[PATH_9LEAP_END_PNG];
