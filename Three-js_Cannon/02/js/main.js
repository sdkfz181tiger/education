...
window.onload = function(){
	...
	let box1   = cm.createBox("myBox1", 0, 0.5, -3, 2, 0.5, 2, 5, 0x333333);
	let sph1   = cm.createSphere("mySphere1", -2, 6, -10, 1);
	let sph2   = cm.createSphere("mySphere2", +2, 9, -15, 1);

	// Tower
	let cyl1   = cm.createCylinder("myCyl1", 0, 0.5+0, 0, 1, 1, 1, 10, 5, C_PURPLE);
	let cyl2   = cm.createCylinder("myCyl2", 0, 0.5+1, 0, 1, 1, 1, 10, 5, C_BLUE);
	let cyl3   = cm.createCylinder("myCyl3", 0, 0.5+2, 0, 1, 1, 1, 10, 5, C_AQUA);
	let cyl4   = cm.createCylinder("myCyl4", 0, 0.5+3, 0, 1, 1, 1, 10, 5, C_GREEN);
	let cyl5   = cm.createCylinder("myCyl5", 0, 0.5+4, 0, 1, 1, 1, 10, 5, C_YELLOW);
	let cyl6   = cm.createCylinder("myCyl6", 0, 0.5+5, 0, 1, 1, 1, 10, 5, C_ORANGE);
	let cyl7   = cm.createCylinder("myCyl7", 0, 0.5+6, 0, 1, 1, 1, 10, 5, C_RED);
